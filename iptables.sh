...
$IPTABLES -A INPUT -i eth0 -p tcp -s $INT_NET --dport 139 --syn -m state --state NEW -j ACCEPT
$IPTABLES -A INPUT -i eth0 -p tcp -s $INT_NET --dport 445 --syn -m state --state NEW -j ACCEPT
$IPTABLES -A INPUT -i eth0 -p udp --dport 67 -m state --state NEW -j ACCEPT
$IPTABLES -A INPUT -i eth0 -p udp --dport 68 -m state --state NEW -j ACCEPT
